...
@RestController
@RequestMapping("books") // /books/shareable/{book-id}
@RequiredArgsConstructor
@Tag(name = "Book")
public class BookController {
    private final BookService service;

    //maps this method to the Http post request
    @PostMapping
    ...
    //Retrieve all borrowed/returned books for the administrator/manager
    @GetMapping("/borrowed")
